...
try {
  ...
  if (process.env.PLAYWRIGHT_CHROMIUM_PATH) {
    ...
    const candidates = [
      "C:\\Users\\mdazh\\AppData\\Local\\ms-playwright\\chromium-1223\\chrome-win64\\chrome.exe",
      "C:\\Users\\mdazh\\AppData\\Local\\ms-playwright\\chromium-1208\\chrome-win64\\chrome.exe",
    ];
    for (const cand of candidates) {
      try {
        if (statSync(cand).isFile()) {
          launchOptions.executablePath = cand;
          break;
        }
      } catch {}
    }
